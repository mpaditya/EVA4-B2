...
class VisualizeCam(object):
	...
	def plot_heatmaps(self, img_data, target_class):
	...
	def __call__(self, images, target_layers, target_inds=None):
		...
		for i in range(min(len(images),5)):
			...
			self.plot_heatmaps(results_data+heatmaps_data, pred_class)