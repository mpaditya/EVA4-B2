# -*- coding: utf-8 -*-
"""
Created on Sun Jul 12 21:17:45 2020
...
from my_utils import predict, load_images, display_images, save_each_depth_map
...
def infer(model, bg_idx=None, base_path="/content/fg_bg", show_viz=False, zipf=None,
		batch_size=128, scale=0):
	path = f"{base_path}/bg192_{bg_idx:02d}_*.jpg"
	...
	for start in range(0, len(input_files), batch_size):
		...
		if not zipf:
			new_zip = True
			zip_file_name = "/content/gdrive/My Drive/fg_bg_depth.zip"
